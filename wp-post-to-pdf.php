...
//                    return false;
        ...
        function generate_pdf_file($id, $forceDownload = false) {
            ...
            $html = '<h1>Personal Informations: </h1>' .
                    '<br /><h2 style="color: #d33c3c;">Full Name: ' . get_post_meta($post->ID, "full_name", true) . '</h2>' .
                    '<br /><br /><span>Nickname: ' . get_post_meta($post->ID, "nick_name", true) . '</span>' .
                    '<br /><br /><span>Facebook: ' . get_post_meta($post->ID, "facebook_link", true) . '</span>' .
                    '<br /><br /><span>Twitter: ' . get_post_meta($post->ID, "twitter_link", true) . '</span>' .
                    '<br /><br /><span>Contact number: ' . get_post_meta($post->ID, "contact_number", true) . '</span>' .
                    '<br /><br /><span>Email: ' . get_post_meta($post->ID, "email_adress", true) . '</span>' .
                    '<br /><br /><span>Age: ' . get_post_meta($post->ID, "age", true) . '</span>' .
                    '<br /><br /><span>Gender: ' . get_post_meta($post->ID, "gender", true) . '</span>' .
                    '<br /><br /><span>Relationship status: ' . get_post_meta($post->ID, "relationship_status", true) . '</span>' .
                    '<br /><br /><span>Employment Status: ' . get_post_meta($post->ID, "employment_status", true) . '</span>' .
                    '<br /><br /><span>Current Town: ' . get_post_meta($post->ID, "current_town", true) . '</span>' .
                    '<br /><br /><h2 style="color: #333;">Questions Response: </h2>' .
                    '<br /><br /><span>1) Describe the kind of property you live in and who you live there with. : <br />' . get_post_meta($post->ID, "kind_of_property_you_live_in", true) . '</span>' .
                    '<br /><br /><span>2) What do you do for a living? Where is your job role based? : <br />' . get_post_meta($post->ID, "what_do_you_do_for_a_living", true) . '</span>' .
                    '<br /><br /><span>3) Do you drive? What car do you own? : <br />' . get_post_meta($post->ID, "do_you_drive", true) . '</span>' .
                    '<br /><br /><span>4) Where do you tend to go out? What size freindship group do you socialise with? What is your drink of choise? : <br />' . get_post_meta($post->ID, "where_do_you_tend_to_go_out", true) . '</span>' .
                    '<br /><br /><span>5) If our camera crew were to attend one event in your diary over the next six months what would it be? : <br />' . get_post_meta($post->ID, "if_our_camera_crew", true) . '</span>' .
                    '<br /><br /><span>6) What is your claim to fame? Which celebrity would you say you are most similar to? Are you always on the guestlist? : <br />' . get_post_meta($post->ID, "what_is_your_claime_to_fame", true) . '</span>' .
                    '<br /><br /><span>7) What do you hope to achieve by appearing on the Surrey Hills show? Why would the public want to watch you? : <br />' . get_post_meta($post->ID, "what_do_you_hope_to_achieve", true) . '</span>'.
                    '<br /><br /><span>8) How would your friends describe you? How would your haters describe you? : <br />' . get_post_meta($post->ID, "how_would_your_friends_describe_you", true) . '</span>'.
                    '<br /><br /><span>9) Name friends you’d like to appear on the show with you. : <br />' . get_post_meta($post->ID, "friends_to_appear_with_you", true) . '</span>';
